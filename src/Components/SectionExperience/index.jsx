          ...
          <div className='dropdown dropdown-one'>
            ...
            <div className='dropdown-content-one'>
              <p>
                ...
                En dicho año y hasta el 2012 construye las bases de su
                experiencia como profesional de la salud mental en el contexto
                clínico al tiempo que ejerce como psicólogo escolar y docente en
                diversas instituciones educativas de prestigio en dicho país
                (Colegio Americano del Sur, Colegio Internacional Montessori y
          ...
          <div className='dropdown dropdown-two'>
            ...
            <div className='dropdown-content-two'>
              <p>
                ...
                de Ciencia y Tecnología (CNPq) para estudiantes y profesionales
                destacados de américa latina, Asia y África.{' '}
              </p>
            </div>
          </div>
        </div>
          ...
          <div className='dropdown dropdown-five'>
            ...
            <div className='dropdown-content-five'>
              <p>
                ...
                de pesquisa Avaliacao e intervencao no ciclo vital de la PUCRS y
                como docente invitado en universidades de Brasil, Guatemala y
                Costa Rica.
              </p>
            </div>
          </div>
