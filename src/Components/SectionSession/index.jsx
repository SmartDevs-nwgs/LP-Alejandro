      ...
      <StyledSectionSessions>
        <section className="free-section">
          ...
          <p>
            ...
            expone los motivos por los cuales busca ayuda psicológica, al final
            de esa primera sesión se define si habrá continuidad en el proceso
            psicoterapéutico de acuerdo con el caso, momento y situación
        ...
        <section className="time-section">
          <div className="info-time-section">
            <p>
              ...
              ser agendadas en el mismo día y horario acordados entre
